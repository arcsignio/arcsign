// Package chainadapter defines the core ChainAdapter interface contract
// This file serves as the canonical API specification for all chain implementations
...
// ChainError represents a classified error
...
// KeySource abstracts key material sources
