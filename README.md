...
[![Version](https://img.shields.io/badge/version-1.1.5-blue.svg)](https://github.com/Jason-chen-taiwan/arcSignv2/releases/tag/v1.1.5)
...
| 平台 | 格式 | 下載連結 |
|------|------|---------|
| macOS (Apple Silicon) | `.dmg` | [ArcSign-1.1.5-macOS-ARM64.dmg](https://github.com/Jason-chen-taiwan/arcSignv2/releases/download/v1.1.5/ArcSign-1.1.5-macOS-ARM64.dmg) |
| Windows (x64) | `.msi` | [ArcSign-1.1.5-Windows-x64.msi](https://github.com/Jason-chen-taiwan/arcSignv2/releases/download/v1.1.5/ArcSign-1.1.5-Windows-x64.msi) |
| Windows (x64) | `.exe` | [ArcSign-1.1.5-Windows-x64-Setup.exe](https://github.com/Jason-chen-taiwan/arcSignv2/releases/download/v1.1.5/ArcSign-1.1.5-Windows-x64-Setup.exe) |
| Linux (x64) | `.deb` | [ArcSign-1.1.5-Linux-x64.deb](https://github.com/Jason-chen-taiwan/arcSignv2/releases/download/v1.1.5/ArcSign-1.1.5-Linux-x64.deb) |
| Linux (x64) | `.AppImage` | [ArcSign-1.1.5-Linux-x64.AppImage](https://github.com/Jason-chen-taiwan/arcSignv2/releases/download/v1.1.5/ArcSign-1.1.5-Linux-x64.AppImage) |
