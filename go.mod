...
require (
	github.com/arcsignio/arcsign/src/chainadapter v0.0.0-00010101000000-000000000000
...
replace github.com/arcsignio/arcsign/src/chainadapter => ./src/chainadapter
